...
@CommandLineInterface(application="sqz export")
@Command(name="export", desc="Export the read sequences from an SQZ file to FASTQ format", cat="sqz", experimental=true)
