...
public class SQZ {
    ...
    public static final byte[] MAGIC_CHUNK = new byte[] { 'S', 'Q', 'Z', 0x02 };

    // used to mark the start of the SQZ data validator - ensures the encryption password is good.
    public static final byte[] MAGIC_CHUNK_DATA = new byte[] { 'S', 'Q', 'Z', 0x03 };

    // used to mark the start of a SQZ text chunk (comments)
    public static final byte[] MAGIC_TEXT_CHUNK = new byte[] { 'S', 'Q', 'Z', 0x04 };
